...
- 사용자는 소셜 로그인(카카오, 구글)을 진행 할 수 있습니다.
- 사용자는 네이버 소셜 로그인을 진행 할 수 있습니다.
  - 네이버는 사업자가 아니면 불특정다수의 로그인 불가능.
- 사용자는 선호하는 아티스트를 저장/삭제 할 수 있습니다.
- 사용자는 선호하는 장르를 저장/삭제 할 수 있습니다. 
- 사용자는 비슷한 사용자들의 선호 아티스트를 추천 받을 수 있습니다. (사용자 팔로우 기반)
...
- 아티스트를 추가/삭제 할 수 있습니다.
- 아티스트의 섬네일을 수정 할 수 있습니다. 
</details>
